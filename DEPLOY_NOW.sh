...
echo "🚀 AI TRADING SYSTEM - DEPLOYMENT COMMANDS"
echo "=========================================="
echo ""
echo "📋 Copy and paste these commands into your server:"
echo ""
...
app.post('/api/command', (req, res) => {
  ...
  const responses = {
    'start trading': 'Paper trading started successfully! 🚀',
    'stop trading': 'Trading stopped successfully! ⏹️',
    'test mt5 connection': 'MT5 connection test - Ports 5555 & 5556 ready! 🔌',
    'get status': 'System running in paper mode - all systems operational! ✅'
  };
  
  const message = responses[command] || `Command "${command}" received in paper trading mode`;
...
app.listen(PORT, '0.0.0.0', () => {
  ...
  console.log(`🌍 Server: London (45.76.136.30)`);
});
EOF
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p><span class="live-indicator"></span>London Server • Paper Trading Mode • Ready for MT5</p>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            console.log('🚀 AI Trading System Dashboard Loaded');
        });
    </script>
</body>
</html>
...
echo ""
echo "💹 Test Commands:"
echo "curl http://45.76.136.30:8000/api/health"
...
echo "ssh root@45.76.136.30"
echo ""
echo "🚀 Step 2: Copy and paste the entire command block above"
echo ""
echo "🌐 After deployment, your system will be live at:"
echo "📊 Dashboard: http://45.76.136.30:3000"
echo "🔧 API Health: http://45.76.136.30:8000/api/health"
echo "📈 Monitoring: http://45.76.136.30:3001"
echo ""
echo "🎊 Your AI Trading System will be ready in 2-3 minutes! 🚀💰"