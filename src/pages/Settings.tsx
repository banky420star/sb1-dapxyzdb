        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <div className="space-y-2">
              <h1 className="text-2xl sm:text-4xl font-bold text-gradient flex items-center">
                <SettingsIcon className="w-6 h-6 sm:w-8 sm:h-8 mr-2 sm:mr-3 text-indigo-400" />
                System Settings
              </h1>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-2 sm:space-y-0 sm:space-x-4">
              {isDirty && (
                <div className="px-3 sm:px-4 py-2 rounded-xl text-xs sm:text-sm font-semibold glass text-yellow-400 border border-yellow-500/30">
                  ⚠️ Unsaved Changes
                </div>
              )}
              <button
                ...
                className="btn-futuristic px-4 sm:px-6 py-2 sm:py-3 flex items-center space-x-2 disabled:opacity-50 text-sm sm:text-base"
              >
          ...
          <motion.div 
            className="flex flex-wrap gap-1 sm:gap-2 glass p-2 rounded-xl mb-6 sm:mb-8"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
