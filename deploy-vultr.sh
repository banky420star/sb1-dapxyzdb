...
echo "🚀 Deploying AI Trading System to Vultr server..."
...
ssh root@45.76.136.30 "cd /root && rm -rf ai-trading-system && mkdir ai-trading-system && cd ai-trading-system && tar -xzf ../ai-trading-system-vultr.tar.gz"
